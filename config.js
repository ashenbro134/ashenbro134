...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'ASHEN',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Ashen;bot;94768738555;https://i.imgur.com/wBpooOh.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'Ashen;𝛥Shen;https://i.imgur.com/wBpooOh.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ASHEN;INDUWARA' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '94768738555,0',
       DEBUG: DEBUG
};
